...
// type AgendaCreate = InferType<typeof agendaCreateSchema>;
...
//     location: string()
// });
// type AgendaAlter = InferType<typeof agendaCreateSchema>;
...
app.post("/agendas", async (req, res) => {
    try {
        // const validatedData: AgendaCreate = await agendaCreateSchema.validate(req.body, { abortEarly: false });
